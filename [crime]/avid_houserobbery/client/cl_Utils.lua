...
if Config.Framework == "ESX" then
    ...
    AddEventHandler('esx:playerLoaded', function(xPlayer, isNew)
        ...
        TriggerServerEvent("avid_houserobbery:sync")
        TriggerServerEvent("avid_houserobbery:missionsync2")
    end)
elseif Config.Framework == "qbcore" then
...
RegisterNetEvent("avid_houserobbery:notify")
AddEventHandler("avid_houserobbery:notify", function(type, title, text)
...
RegisterNetEvent("avid_houserobbery:lootbag")
AddEventHandler("avid_houserobbery:lootbag", function()
