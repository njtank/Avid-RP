...
-- Turning this off, as we do not need a keybind for this action
...
-- Send a notification to the tablet from anywhere
RegisterNetEvent("avid-tablet:client:CustomNotification", function(title, text, icon, color, timeout)
