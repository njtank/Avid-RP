...
local DISCORD_WEBHOOK = 'https://discord.com/api/webhooks/1221617667786408027/ESruznUEnob9wdVOmdmTJKdzOyhTVE3wFliIwosWh0auStJfVuvJgd0f4XVNFPF1zBqt'                         -- Your discord webhook here
local COLOR = '1327473'                                                                                                                             -- Color of the embed
local DISCORD_NAME = "BitPix GoPostal Bot"                                                                                                            -- Name of the bot
local DISCORD_IMAGE = ""
