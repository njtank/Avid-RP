...
RegisterNetEvent('avid-mining:ResetisMining', function()
  isMining = false
end)

RegisterNetEvent('avid-mining:ResetisProcess', function()
  isProcess = false
end)

RegisterNetEvent('avid-mining:ResetisBreakdown', function()
  isBreakdown = false
end)
