...
SD.Inventory.RegisterUsableItem('parcel', function(source)
    TriggerClientEvent('avid-parceltheft:client:openBox', source)
end)

SD.Callback.Register('avid-parceltheft:server:GetLocations', function(source)
...
local TakePackage = function(src, propId)
    ...
    TriggerClientEvent('avid-parceltheft:client:RemoveProp', -1, propId)
end
...
RegisterNetEvent('avid-parceltheft:server:deleteParcel', function()
    local src = source
...
RegisterNetEvent('avid-parceltheft:server:MarkPropTaken', function(propId)
    local src = source
    ...
    CreateThread(function()
        ...
        TriggerClientEvent('avid-parceltheft:client:ResetProp', -1, propId)
    end)
end)

SD.CheckVersion('Samuels-Development/avid-parceltheft') -- Check version of specified resource
