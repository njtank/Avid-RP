...
Config.fish = {
    ['anchovy'] = { price = { min = 5, max = 10 }, chance = 35, skillcheck = { 'easy', 'medium' } },
    ['trout'] = { price = { min = 10, max = 20 }, chance = 35, skillcheck = { 'easy', 'medium' } },
    ['haddock'] = { price = { min = 15, max = 25 }, chance = 20, skillcheck = { 'easy', 'medium' } },
    ['salmon'] = { price = { min = 25, max = 30 }, chance = 10, skillcheck = { 'easy', 'medium', 'medium' } },
    ['grouper'] = { price = { min = 30, max = 40 }, chance = 25, skillcheck = { 'easy', 'medium', 'medium', 'medium' } },
    ['piranha'] = { price = { min = 35, max = 45 }, chance = 25, skillcheck = { 'easy', 'medium', 'hard' } },
    ['red_snapper'] = { price = { min = 45, max = 50 }, chance = 20, skillcheck = { 'easy', 'medium', 'medium', 'medium' } },
    ['mahi_mahi'] = { price = { min = 50, max = 60 }, chance = 20, skillcheck = { 'easy', 'medium', 'medium', 'medium' } },
    ['tuna'] = { price = { min = 80, max = 100 }, chance = 5, skillcheck = { 'easy', 'medium', 'hard' } },
    ['shark'] = { price = { min = 540, max = 650 }, chance = 1, skillcheck = { 'easy', 'medium', 'hard' } },
}
...
Config.baits = {
    ...
    { name = 'artificial_bait', price = 20, minLevel = 2, waitDivisor = 3.0 },
}
...
Config.renting = {
    ...
    account = 'money',
    boats = {
        { model = `speeder`, price = 50, image = 'https://i.postimg.cc/mDSqWj4P/164px-Speeder.webp' },
        { model = `dinghy`, price = 75, image = 'https://i.postimg.cc/ZKzjZgj0/164px-Dinghy2.webp'  },
        --{ model = `tug`, price = 125, image = 'https://i.postimg.cc/jq7vpKHG/164px-Tug.webp' }
    },
    blip = {
        name = 'Boat Rental',
        sprite = 410,
