...
Config.ClothingRooms = {
    {
        job = "police",
        coords = vec4(462.37, -996.65, 30.69, 89.56),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
    ...
    {
        job = "firefigher",
        coords = vec4(368.42, -1104.46, 35.23, 273.55),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vec3(371.6, -1101.6, 35.23),
            vec3(372.17, -1107.63, 35.23),
            vec3(361.15, -1102.21, 35.23),
            vec3(361.15, -1107.01, 35.23),
        }
    }
}
