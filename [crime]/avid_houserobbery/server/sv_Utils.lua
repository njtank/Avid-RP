...
CreateThread(function()
    if GetResourceState(GetCurrentResourceName()) == 'started' then
        print('avid_houserobbery STARTED ON VERSION: ' .. ver)
    end
end)
...
RegisterUsable("loot_bag", function(source)
    ...
    TriggerClientEvent('avid_houserobbery:lootbag', src)
end)
...
RegisterUsable('house_locator', function(source)
    ...
    if onTimer[src] and onTimer[src] > GetGameTimer() then
        TriggerClientEvent('avid_houserobbery:notify', src, 'error', locale('houserobbery'), locale('ItemCooldown', math.floor((onTimer[src] - GetGameTimer()) / 1000 + 0.5)))
        return
    end
    TriggerClientEvent('avid_houserobbery:gethelp', src)
...
RegisterUsable("powder", function(source)
    ...
    TriggerClientEvent("avid_houserobbery:powder", src)
end)
...
lib.callback.register('avid_houserobbery:getident', function(source)
