...
RegisterNetEvent('avid-weed:client:takeDrug', function(drugItem)
...
lib.callback.register('avid-weed:client:isDrugOnCooldown', function(drugItem)
...
lib.callback.register('avid-weed:client:getCurrentDrugEffect', function()
    return currentDrug
end)