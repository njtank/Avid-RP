...
AddEventHandler("avid-atmrobbery:robberyCall", function(coords)
    QBCore.Functions.Notify("Fleeca Bank", "alert_notify_title", "alert_notify_started", "CHAR_CALL911", 1)

    if not coords then
        RemoveBlip(blip)
        QBCore.Functions.Notify("Fleeca Bank", "alert_notify_title", "alert_notify_ended", "CHAR_CALL911", 1)
