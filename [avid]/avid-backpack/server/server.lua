...
RegisterServerEvent('avid-backpack:openBackpack')
AddEventHandler('avid-backpack:openBackpack', function(identifier)
...
lib.callback.register('avid-backpack:getNewIdentifier', function(source, slot)
