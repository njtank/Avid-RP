...
RegisterNetEvent('avid-weed:server:processDrugs', function(entity, recipe)
...
RegisterNetEvent('avid-weed:server:removeTable', function(args)
...
RegisterNetEvent('avid-weed:server:createNewTable', function(coords, type, rotation, metadata)
    local src = source
...
-- Callbacks
lib.callback.register('avid-weed:server:getTableData', function(source, netId)
...
lib.callback.register('avid-weed:server:getTables', function(source)
