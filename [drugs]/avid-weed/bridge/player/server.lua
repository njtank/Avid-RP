...
-- OX Callbacks
lib.callback.register('avid-weed:getPlayerName', function(source)
    return it.getPlayerName(source)
end)

lib.callback.register('avid-weed:getCitizenId', function(source)
    return it.getCitizenId(source)
end)

lib.callback.register('avid-weed:getLicences', function(source)
    return it.getLicences(source)
end)

lib.callback.register('avid-weed:getLicence', function(source, licenseType)
