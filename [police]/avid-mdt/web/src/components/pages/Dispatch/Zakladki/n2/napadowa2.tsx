...
const Napadowa2:React.FC = () => {
    ...
    const setSV = (self: boolean) => {
        ...
        fetchNui('setNapadowaSV', {zakladkaType: 'napadowa2', sv: sv})
    }
    ...
    const setNego = (self: boolean) => {
        ...
        fetchNui('setNapadowaNEGO', {zakladkaType: 'napadowa2', nego: nego})
    }


    const clearnapadowa = () => {
        fetchNui("clearNapadowa", {zakladkaType: 'napadowa2'})
    }

    const removePatrol = () => {
        if (clickedPatrol == null) return;
        setRemoveModal(false)
        fetchNui("removeUnit", {zakladkaType: 'napadowa2', index: clickedPatrol + 1})
    ...
    const submitEdit = () => {
        ...
        if(editedOfficer1 != '' && editedOfficer2 != '' && editedOfficer3 != '' && editedOfficer4 != '' && editedOfficer5 != ''){
            if (clickedPatrol === null) {
                ...
                fetchNui("createUnit", {zakladkaType: 'napadowa2', unit: editedUnit, vehicle: editedVehicle, officers: officers, patrolUnit: pu})
                setClickedPatrolUnit(null)
            } else {
                var officers = {
                    officer1: editedOfficer1,
                ...
                fetchNui("editUnit", {zakladkaType: 'napadowa2', index: clickedPatrol + 1, unit: editedUnit, vehicle: editedVehicle, officers: officers, patrolUnit: pu})
                setClickedPatrolUnit(null)
            }
        }
    }
    ...
    const ZadaniaChange = (z: string) => {
        fetchNui("updateZadaniaAkcyjna", {zakladkaType: 'napadowa2', text: z})
    }

    const NotatkiChange = (z: string) => {
        fetchNui("updateNotatkiAkcyjna", {zakladkaType: 'napadowa2', text: z})
    }

    const RabunekChange = (z: string) => {
        fetchNui("updateRabunekAkcyjna", {zakladkaType: 'napadowa2', text: z})
    }
