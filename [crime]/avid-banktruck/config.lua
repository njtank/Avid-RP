...
Config.ServerPrints = false                  -- If true provides some minor information on the heist periodically
...
Config.AllowLeoRob = true                  -- If true lets LEOs start the event/rob the truck
