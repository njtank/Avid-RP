...
local keyToggle = 56 -- Sets engine toggle button to F9, view list of controls here if you wish to change: https://docs.fivem.net/docs/game-references/controls/#controls
