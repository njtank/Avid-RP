...
Config.FrameworkResource = "qbx" -- Framework resource name
...
Config.ProgessBar = 'ox_libe' -- ox_lib / qb
...
Config.WeatherSync = 'renewed-weathersync'
...
Config.DispatchResource = 'ps-dispatch' -- The dispatch system resource folder name
...
Config.FuelResource = 'cdn-fuel' -- The fuel system resource folder name
...
Config.VehicleKeys = 'renewed_vehiclekeys'
Config.VehicleKeysResource = 'renewed_vehiclekeys' -- The vehicle key system resource folder name
...
Config.SkillMenu = { -- Configuration for skill menu.
    Enabled = false, -- Should the Skill Menu be enabled
