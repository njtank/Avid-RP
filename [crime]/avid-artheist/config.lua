Config = {}
Config['ArtHeist'] = {
    ['nextRob'] = 1800, -- seconds for next heist, -- 30 mins
...
Strings = {
    ['steal_blip'] = 'La Fuente Blanca Mansion',
    ['sell_blip'] = 'Sell Paintings',
    ['start_stealing'] = 'Press ~INPUT_CONTEXT~ to start art extraction',
    ...
    ['go_steal'] = 'Go to La Fuente Blanca marked on your map and break in to swipe those priceless paintings.',
    ['go_sell'] = 'The pawn shop might pay a hefty price for these paintings.',
    ['already_cuting'] = 'You are already stealing.',
    ['already_heist'] = 'You already started the art heist. Wait until its over.',
    ['start_heist'] = 'Press ~INPUT_CONTEXT~ to start an art heist',
    ['sell_painting'] = 'Press ~INPUT_CONTEXT~ to sell paintings',
    ['wait_nextrob'] = 'You have to wait this long to start heist again',
    ['minute'] = 'Minute',
