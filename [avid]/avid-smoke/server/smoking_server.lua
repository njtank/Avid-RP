...
QBCore.Functions.CreateUseableItem("redwoodpack", function(source, item)
    TriggerClientEvent("bprp-smoke:client:RedwoodPack", source)
end)
QBCore.Functions.CreateUseableItem("debonairepack", function(source, item)   
    TriggerClientEvent("bprp-smoke:client:DebonairePack", source)
end)
QBCore.Functions.CreateUseableItem("69brandpack", function(source, item)
   
    TriggerClientEvent("bprp-smoke:client:69BrandPack", source)
end)
QBCore.Functions.CreateUseableItem("yukonpack", function(source, item)
   
    TriggerClientEvent("bprp-smoke:client:YukonPack", source)
end)



QBCore.Functions.CreateUseableItem("cigs", function(source, item)
    TriggerClientEvent("bprp-smoke:client:SmokeCig", source)
end)

QBCore.Functions.CreateUseableItem("vape", function(source, item)
    TriggerClientEvent("bprp-smoke:client:SmokeVape", source)
end)
...
RegisterNetEvent('bprp-smoke:server:OpenRedwoodPack', function()
    local src = source
...
RegisterNetEvent('bprp-smoke:server:OpenDebonairePack', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('bprp-smoke:server:Open69BrandPack', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('bprp-smoke:server:OpenYukonPack', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateCallback('bprp-smoke:get:Cigs', function(source, cb)
    local src = source
...
QBCore.Functions.CreateCallback('bprp-smoke:get:Vape', function(source, cb)
    local src = source
    local Ply = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('bprp-smoke:server:SmokeVape', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)

    local chance = math.random(1,100)
    local chance1 = 15 -- edit this value for the chance of juice to be removed when smoking a vape currently a 1 in 4 chance
...
RegisterNetEvent('bprp-smoke:server:SmokeCig', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if InvType == 'qb' then
