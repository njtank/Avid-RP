...
RegisterCommand('avid_rdm:SaveRecording', function()
...
RegisterCommand('avid_rdm:StopRecording', function()
    if keybindsActive then
        DisablePrompt()
...
RegisterKeyMapping('avid_rdm:SaveRecording', '.Save Recording', 'keyboard', 'e')
RegisterKeyMapping('avid_rdm:StopRecording', '.Stop Recording', 'keyboard', 'j')

function TriggerRecording(message)
    local startKeybind = GetKeyLabel(GetHashKey('avid_rdm:SaveRecording'))
    local endKeybind = GetKeyLabel(GetHashKey('avid_rdm:StopRecording'))
