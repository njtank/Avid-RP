    ...
    locations = { -- Various interaction points
        ...
        hospitals = {
            pillbox = {
                ...
                beds = {
                    {coords = vec4(321.37, -581.73, 44.12, 154.91), model = 1631638868},
                    {coords = vec4(318.53, -580.55, 44.12, 165.44), model = 1631638868},
                    {coords = vec4(316.78, -584.43, 44.12, 335.15), model = 2117668672},
                    {coords = vec4(319.74, -585.26, 44.12, 335.15), model = 2117668672},
                    {coords = vec4(322.54, -586.5, 44.12, 335.15), model = 2117668672},
                    {coords = vec4(325.51, -587.56, 44.12, 335.15), model = -1091386327},
                    {coords = vec4(328.39, -588.52, 44.12, 335.15), model = -1091386327},
                    {coords = vec4(330.46, -585.04, 44.12, 335.15), model = -1091386327},
                    {coords = vec4(327.71, -583.85, 44.12, 148.96), model = -1091386327},
                },
            },
            paleto = {
