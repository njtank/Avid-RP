...
lib.callback.register('avid_houserobbery:SellShop:getitem', function(source, item, amount)
    local src = source
...
RegisterServerEvent("avid_houserobbery:SellShop:sellall")
AddEventHandler("avid_houserobbery:SellShop:sellall", function()
    local src = source
...
RegisterServerEvent("avid_houserobbery:SellShop:giveitems")
AddEventHandler("avid_houserobbery:SellShop:giveitems", function(item, price, amount)
    local src = source
    if onTimerSellShop[src] and onTimerSellShop[src] > GetGameTimer() then
        Logs(src, "HouseRobbery (SellShop, Timer): Player Tried to exploit Event")
        BanPlayer(src, "HouseRobbery (SellShop, Timer): Player Tried to exploit Event")
