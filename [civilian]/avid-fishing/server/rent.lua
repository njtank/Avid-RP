...
lib.callback.register('avid-fishing:rentVehicle', function(source, index)
...
RegisterNetEvent('avid-fishing:registerBoat', function(netId)
    local source = source
...
lib.callback.register('avid-fishing:returnVehicle', function(source, netId)
    local player = Framework.getPlayerFromId(source)
