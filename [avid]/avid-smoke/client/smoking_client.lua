...
--open pack of cigs
RegisterNetEvent('bprp-smoke:client:RedwoodPack', function()
    ...
    QBCore.Functions.Progressbar("open_pack", "Opening Cigarette Pack", Config.CoreSettings.ProgressBar.OpenPack, false, true, {
        ...
        TriggerServerEvent('bprp-smoke:server:OpenRedwoodPack')
    end, function() -- Cancel
        ClearPedTasks(PlayerPedId())
        DeleteEntity(prop)
        if Config.CoreSettings.Notify.Type == 'qb' then
...
RegisterNetEvent('bprp-smoke:client:DebonairePack', function()
    local prop = CreateObject(packetprop, GetEntityCoords(PlayerPedId()), true, true, true)
    AttachEntityToEntity(prop, PlayerPedId(), GetPedBoneIndex(PlayerPedId(), 57005), 0.14, 0.01, -0.03, 2.0, 68.0, -32.0, true, true, false, false, 1, true)
    QBCore.Functions.Progressbar("open_pack", "Opening Cigarette Pack", Config.CoreSettings.ProgressBar.OpenPack, false, true, {
        disableMovement = false,
        ...
        TriggerServerEvent('bprp-smoke:server:OpenDebonairePack')
    end, function() -- Cancel
        ClearPedTasks(PlayerPedId())
        DeleteEntity(prop)
        if Config.CoreSettings.Notify.Type == 'qb' then
...
RegisterNetEvent('bprp-smoke:client:69BrandPack', function()
    local prop = CreateObject(packetprop, GetEntityCoords(PlayerPedId()), true, true, true)
    AttachEntityToEntity(prop, PlayerPedId(), GetPedBoneIndex(PlayerPedId(), 57005), 0.14, 0.01, -0.03, 2.0, 68.0, -32.0, true, true, false, false, 1, true)
    QBCore.Functions.Progressbar("open_pack", "Opening Cigarette Pack", Config.CoreSettings.ProgressBar.OpenPack, false, true, {
        disableMovement = false,
        ...
        TriggerServerEvent('bprp-smoke:server:Open69BrandPack')
    end, function() -- Cancel
        ClearPedTasks(PlayerPedId())
        DeleteEntity(prop)
        if Config.CoreSettings.Notify.Type == 'qb' then
...
RegisterNetEvent('bprp-smoke:client:YukonPack', function()
    local prop = CreateObject(packetprop, GetEntityCoords(PlayerPedId()), true, true, true)
    AttachEntityToEntity(prop, PlayerPedId(), GetPedBoneIndex(PlayerPedId(), 57005), 0.14, 0.01, -0.03, 2.0, 68.0, -32.0, true, true, false, false, 1, true)
    QBCore.Functions.Progressbar("open_pack", "Opening Cigarette Pack", Config.CoreSettings.ProgressBar.OpenPack, false, true, {
        disableMovement = false,
        ...
        TriggerServerEvent('bprp-smoke:server:OpenYukonPack')
    end, function() -- Cancel
        ClearPedTasks(PlayerPedId())
        DeleteEntity(prop)
        if Config.CoreSettings.Notify.Type == 'qb' then
...
--smoke cig
RegisterNetEvent('bprp-smoke:client:SmokeCig', function()
    QBCore.Functions.TriggerCallback('bprp-smoke:get:Cigs', function(HasItems)  
        if HasItems then
            ...
            QBCore.Functions.Progressbar("smoke_cig", "Smoking A Cigarette", Config.CoreSettings.ProgressBar.SmokeCig, false, true, {
                ...
                TriggerServerEvent('bprp-smoke:server:SmokeCig')
...
--smoke vape
RegisterNetEvent('bprp-smoke:client:SmokeVape', function()
    QBCore.Functions.TriggerCallback('bprp-smoke:get:Vape', function(HasItems)  
        if HasItems then
           local prop = CreateObject(vapeprop, GetEntityCoords(PlayerPedId()), true, true, true)
            ...
            QBCore.Functions.Progressbar("smoke_vape", "Smoking A Vape", Config.CoreSettings.ProgressBar.SmokeVape, false, true, {
                ...
                TriggerServerEvent('bprp-smoke:server:SmokeVape')
...
--open smoking shop
RegisterNetEvent("bprp-smoke:client:openShop", function()
    if ShopType == 'qb'then
        ...
        options = {
            {
                ...
                event = "bprp-smoke:client:openShop",
