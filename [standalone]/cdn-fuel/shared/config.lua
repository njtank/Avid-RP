...
Config.CostMultiplier = .25 -- Amount to multiply 1 by. This indicates fuel price. (Default: $3.0/l or 3.0)
...
Config.MaxFuelPrice = 1 -- This is the maximum value you want to let players set their fuel prices to.
...
Config.AirAndWaterVehicleFueling = {
    ...
    ['water_fuel_price'] = 3, -- Price Per Liter of Fuel for Water Vehicles (Emergency Services Discount Still Applies)
}
