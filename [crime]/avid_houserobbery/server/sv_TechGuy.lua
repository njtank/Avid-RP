...
local onTimerShop = {}
lib.callback.register('avid_houserobbery:Shop:getitem', function(source, price, amount)
    local src = source
...
RegisterServerEvent("avid_houserobbery:Shop:giveitems")
AddEventHandler("avid_houserobbery:Shop:giveitems", function(item, price, amount)
    local src = source
