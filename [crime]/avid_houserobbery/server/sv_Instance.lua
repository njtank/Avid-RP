...
RegisterNetEvent("avid_houserobbery_instance:addEntityToPlayerInstance")
AddEventHandler("avid_houserobbery_instance:addEntityToPlayerInstance", function(entity)
    local src = source
...
RegisterNetEvent("avid_houserobbery_instance:joinInstance")
AddEventHandler("avid_houserobbery_instance:joinInstance", function(instance)
    local src = source
    playerJoinInstance(src, instance)
end)

RegisterNetEvent("avid_houserobbery_instance:quitInstance")
AddEventHandler("avid_houserobbery_instance:quitInstance", function()
    local src = source
...
function playerJoinInstance(player, instanceName)
    ...
    TriggerClientEvent("avid_houserobbery_instance:onEnter", player, instanceName)
...
function playerQuitInstance(player)
    if GetPlayerRoutingBucket(player) ~= 0 then
        TriggerClientEvent("avid_houserobbery_instance:onLeave", player)
    end
