...
if Config.checkForUpdates then
    ...
    local resourceName = "avid-backpack"

    CreateThread(function()
        if GetCurrentResourceName() ~= "avid-backpack" then
            resourceName = "avid-backpack (" .. GetCurrentResourceName() .. ")"
        end
    end)

    CreateThread(function()
        while true do
            PerformHttpRequest("https://api.github.com/repos/wasabirobby/avid-backpack/releases/latest", CheckVersion, "GET")
            Wait(3600000)
        end
    end)
    ...
    GetRepoInformations = function()
        ...
        PerformHttpRequest("https://api.github.com/repos/wasabirobby/avid-backpack/releases/latest", function(err, response, headers)
            if err == 200 then
                ...
                repoURL = "https://github.com/wasabirobby/avid-backpack"
            end
        end, "GET")
