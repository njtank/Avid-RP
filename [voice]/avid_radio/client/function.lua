...
function Radio:connecttoradio(channel)
    if self.RadioChannel ~= 0 then
        TriggerServerEvent('avid_radio:server:removeFromRadioChannel', self.RadioChannel)
    end
    ...
    TriggerServerEvent('avid_radio:server:addToRadioChannel', self.RadioChannel, self.userData[self.identifier].name)
    self:connectSound()
...
function Radio:update()
    local battery, radioId = lib.callback.await('avid_radio:server:getradiodata', false)
                ...
                options = {
                    {
                        ...
                        icon = 'fa-toggle-on',
                        onSelect = function ()
                            TriggerServerEvent('avid_radio:server:togglejammer', Radio.jammer[i].id)
                    ...
                    },
                    {
                        ...
                        onSelect = function ()
                            TriggerServerEvent('avid_radio:server:removejammer', Radio.jammer[i].id, isDamaged)
                        end
                    },
                    {
                        ...
                        onSelect = function ()
                            ...
                            TriggerServerEvent('avid_radio:server:changeJammerRange', Radio.jammer[i].id, input[1])
                            lib.showTextUI('[E] Configure Jammer')
                        end
                    },
                    {
                        ...
                        onSelect = function ()
                            ...
                            for j=1, #Radio.jammer[i].allowedChannels do
                                allowedChannels.options[#allowedChannels.options+1] = {
                                    ...
                                    onSelect = function ()
                                        ...
                                        TriggerServerEvent('avid_radio:server:removeallowedchannel', Radio.jammer[i].id, Radio.jammer[i].allowedChannels)
                                        lib.showTextUI('[E] Configure Jammer')
                                    end
                                }
                            end
                            allowedChannels.options[#allowedChannels.options+1] = {
                                ...
                                onSelect = function ()
                                    ...
                                    TriggerServerEvent('avid_radio:server:addallowedchannel', Radio.jammer[i].id, Radio.jammer[i].allowedChannels)
                                    lib.showTextUI('[E] Configure Jammer')
                                end
                            }
    ...
    onPressed = function()
        if not Radio.usingRadio then
            if Shared.Inventory and Radio.hasRadio then
                TriggerEvent('avid_radio:client:use')
...
if Shared.Battery.state then
    CreateThread(function()
        while true do
            TriggerServerEvent('avid_radio:server:consumeBattery', Radio.batteryData)
